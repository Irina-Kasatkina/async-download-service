# Асинхронный микросервис для скачивания файлов
...
```bash
python server.py [параметры_командной_строки]
```
...
-d - включить задержку отправки архива (для имитации плохого интернета);
